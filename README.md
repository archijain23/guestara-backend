...
```
src/
├── app.js              # Express app with all the routes
├── config/
...
```
id, subcategory_id, name, description, image, 
...
**Example**: "Banquet Hall - ₹5000 for 3hrs, ₹8000 for 6hrs"
...
Always returns ₹0. Simple.

### 4. Discounted Pricing
**What it is**: Items on sale  
**Example**: "Seasonal Special - Was ₹1000, now 20% off"
...
Supports both flat (₹50 off) and percentage (20% off) discounts. I added a safety check to make sure the discount never exceeds the base price.

### 5. Dynamic Pricing
**What it is**: Different prices at different times  
**Example**: "Happy Hour Beer - ₹199 (6pm-8pm), normally ₹299"
